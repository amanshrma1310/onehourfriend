...
export async function GET() {
  ...
  try {
    ...
    return NextResponse.json({
      status: "SUCCESS",
      message: "All database tables (User, Session, Message, Friendship, etc.) have been created successfully in Hostinger MySQL!",
      tablesCount: CREATE_TABLES_SQL.length,
    ...
    return NextResponse.json(
      {
        status: "ERROR",
        error: error.message || "Failed to execute table creation SQL",
